...
for(let i =0; i < inventory.length; i++){
    if(inventory[i] === inventory[32]){
        console.log(`Car 33 is a ${inventory[i].car_year} the make is a ${inventory[i].car_make} and the model is ${inventory[i].car_model}.`)
    }
}
...
for(let i = 0; i < inventory.length; i++){
        ...
        if(inventory[i] === inventory[inventory.length-1]){
            console.log(`Make of car ${inventory[i].car_make}, Model of Car ${inventory[i].car_model}`)
        }
}
